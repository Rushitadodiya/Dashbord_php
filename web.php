            ...
            <main class="col-md-9">
                ...
                <div class="container">
                    ...
                    <div class="dashboard-item">
                        ...
                        <div class="btn-group">
                        <a href="https://github.com/Rushitadodiya/web_dev_php_script_work" target="_blank"><button class="ocean-blue-button gradient-button">Task 1</button></a>
                        <a href="https://github.com/Rushitadodiya/web_dev_php_script_work" target="_blank"><button class="sunset-orange-button gradient-button">Task 2</button></a>
                        <a href="https://github.com/Rushitadodiya/web_dev_php_script_work" target="_blank"><button class="spring-green-button gradient-button">Task 3</button></a>
                        
<button class="royal-purple-button gradient-button">Task 4</button>
<button class="ruby-red-button gradient-button">Task 5</button>
<a href="https://github.com/Rushitadodiya/web_dev_php_script_work/tree/main/Array_EXE" target="_blank"><button class="spring-green-button gradient-button p-4">Array_EXC</button></a>
